...
// Importing all necessary modules for the Project
...
@NgModule({
  ...
  imports: [
	...
	MatMenuModule,
	MatCardModule, /*Used to display the posts as cards*/
	MaterialFileInputModule,
    AngularFireModule.initializeApp(environment.firebaseConfig), /*calling firebase configurations*/
